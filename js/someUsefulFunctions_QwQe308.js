...
function addBulkBuy(item,cost,level,costAdd){
  var bulk = OmegaNum.affordArithmeticSeries(item,cost,costAdd,level)
  var cost = OmegaNum.sumArithmeticSeries(bulk,cost,costAdd,level)
  return {bulk:bulk,cost:cost}
}
//同样是批量,显示用
